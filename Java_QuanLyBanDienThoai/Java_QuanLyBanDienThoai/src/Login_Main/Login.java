...
public class Login {
    ...
    public void sendSDT(String sdt, String code) {
        ...
        capNhatPass(code);
        System.out.println("");
        System.out.println("CẢM ƠN BẠN ĐÃ SỬ DỤNG PHẦN MỀM CỦA CB-GROUP !");
        System.out.println("@copyright 2021 By Nguyen Chi Bao va Cong su");
    }
        ...
        do {
            ...
            switch (chon) {
                ...
                case 3: {
                    System.out.println("");
                    System.out.println("CẢM ƠN BẠN ĐÃ SỬ DỤNG PHẦN MỀM CỦA CB - GROUP !");
                    System.out.println("@copyright 2021 By Nguyen Chi Bao");
                    System.exit(0);
                }
                default: {
